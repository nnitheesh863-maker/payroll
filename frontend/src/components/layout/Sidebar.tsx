...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white/95 backdrop-blur-md border-r border-[#EADBCE]/90 flex flex-col shrink-0 h-screen sticky top-0 shadow-[2px_0_15px_rgba(120,53,15,0.03)]">
      {/* Brand Header with Glowing Badge */}
      <div className="h-16 flex items-center px-5 border-b border-[#EADBCE]/80 gap-3">
